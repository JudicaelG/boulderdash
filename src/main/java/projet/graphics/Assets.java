...
public class Assets {
    ...
    public static BufferedImage wall, mud, mud_none, rock, diamond1, diamond2, door, weird, wall_special, buzzbuzz, puffpuff, star;
    ...
    public static void init() {
        ...
        rock =          sheet_DecorsMonsters.crop(SPRITE_SIZE*3,0,SPRITE_SIZE,SPRITE_SIZE);
