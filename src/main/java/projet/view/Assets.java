...
public class Assets {
    ...
    // Player
		...
		bat = new BufferedImage[4];
		bat[0] = sheet_bat.crop(SPRITE_SIZE*9, SPRITE_SIZE*8, SPRITE_SIZE, SPRITE_SIZE);
		bat[1] = sheet_bat.crop(SPRITE_SIZE*9, SPRITE_SIZE*9, SPRITE_SIZE, SPRITE_SIZE);
		bat[2] = sheet_bat.crop(SPRITE_SIZE*9,SPRITE_SIZE*10, SPRITE_SIZE, SPRITE_SIZE);
		bat[3] = sheet_bat.crop(SPRITE_SIZE*9,SPRITE_SIZE*11, SPRITE_SIZE, SPRITE_SIZE);
